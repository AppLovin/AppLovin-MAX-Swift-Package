...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.3.0.xcframework.zip",
            checksum: "c72f453c202facc85585f987a250f399d200cfd881a221116c13fccea0fe664a"
        )
    ]
)
