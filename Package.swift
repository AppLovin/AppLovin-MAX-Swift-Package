...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.11.1.xcframework.zip",
            checksum: "499bfd5c532175578ea50ca486115b0b6c1aff34e369cb3b89a108c85a7bb09f"
        )
    ]
)
