...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-13.4.0.xcframework.zip",
            checksum: "4f4cebddd021f7d6e0375ddf6c66b6d651639b4d33dc7c3606b743a62ffb51f0"
        )
    ]
)
