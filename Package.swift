...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-12.3.0.xcframework.zip",
            checksum: "09d9f1b75e9d24d67c9fa8ba385763d49da448888a257ccdbebb5cb188870d1a"
        )
    ]
)
