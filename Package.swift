...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-13.3.0.xcframework.zip",
            checksum: "4947d1cb5e14d2377412600f90fb5d58d606b41a15969791c76386a193abf35a"
        )
    ]
)
