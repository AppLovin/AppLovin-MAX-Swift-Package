...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.4.4.xcframework.zip",
            checksum: "e0a61eb0a0d6f51e806e8bfb27a1d3a8beb14cd4955e5c963b5c488be3aabebe"
        )
    ]
)
