...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-13.2.0.xcframework.zip",
            checksum: "0f5f991b0026fb72aff8c0f290fa854c19997cce1a65f07af2400908343501c6"
        )
    ]
)
