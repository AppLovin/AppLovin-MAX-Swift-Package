...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.3.3.xcframework.zip",
            checksum: "dbeec7f05e6a889466b49c7aba79122b38666b57b5dc7dc5cc3ed4bec64df097"
        )
    ]
)
