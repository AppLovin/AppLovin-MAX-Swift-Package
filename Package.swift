...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-12.2.0.xcframework.zip",
            checksum: "c1f705d56e289c974d7cb75b2f8bc98b4111cf1dcf0d300e21371c9058beed2c"
        )
    ]
)
