...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-12.2.1.xcframework.zip",
            checksum: "fcace2f5490429a6b5b6c53e21d1de5de874532cc77c3701d94207ae9ef687be"
        )
    ]
)
