...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.10.0.xcframework.zip",
            checksum: "1ac591726179d274e3bba9417adb0444a72fdbbef8a35b7cd4d2696bee84ea8b"
        )
    ]
)
