...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.5.5.xcframework.zip",
            checksum: "abb64b6b4670c1acf6113edd132536cdfe98f83bf1335e15fde8aa9fda8c448c"
        )
    ]
)
