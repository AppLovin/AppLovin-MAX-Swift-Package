...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.1.2.xcframework.zip",
            checksum: "9d6d026457cd654b7ad340d9189b3265e6700ec84d4cb0711eed087f3b289670"
        )
    ]
)
