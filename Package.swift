...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-13.6.1.xcframework.zip",
            checksum: "6122ea9a54577d6f386c7d697b1a9c00a115ed63b147174d12be5a82ca0c6bcc"
        )
    ]
)
