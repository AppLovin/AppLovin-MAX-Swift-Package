...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.6.0.xcframework.zip",
            checksum: "89df3e1ecc6723b749d0f32309ccbc12e9ca70409dbf79f93e62163b01e59d3e"
        )
    ]
)
