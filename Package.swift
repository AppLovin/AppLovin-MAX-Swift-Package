...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.2.1.xcframework.zip",
            checksum: "e204b63e6d802bd028c714775232eac354b091baedf102ab58d3e44e469628c6"
        )
    ]
)
