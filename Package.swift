...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-13.0.0.xcframework.zip",
            checksum: "4817bae25512ce890cf06956a9e3210f6c2df71c92b4e047a9c2c38366bc2f36"
        )
    ]
)
