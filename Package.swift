...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.3.2.xcframework.zip",
            checksum: "18fdb66ef3fff08a766c076f10789d9051bac2573e2f6c3be6ed68cfe6f2f9b1"
        )
    ]
)
