...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.8.0.xcframework.zip",
            checksum: "e4545fabcad09a1c07e400b2dfd9cf812d604c4efac5a0ac3e1ed2c654cf8912"
        )
    ]
)
