...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.4.1.xcframework.zip",
            checksum: "8a79c93c40d57f8e09a13ed6f0314d3397be0a1219917b8b93de71de7db828ee"
        )
    ]
)
