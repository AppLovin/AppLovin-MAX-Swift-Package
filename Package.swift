...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.5.1.xcframework.zip",
            checksum: "d4fc7375c4a1291f7a5e9450e42b658d2d6b4c082115c4dcfbded0896d78255f"
        )
    ]
)
