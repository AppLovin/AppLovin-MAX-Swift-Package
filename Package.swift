...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-12.5.0.xcframework.zip",
            checksum: "d589a45cbddce91adbeee2d1d1198ca4875a361c3f71b69531f9f2e87eaebd8e"
        )
    ]
)
