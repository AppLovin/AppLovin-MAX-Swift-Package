...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-13.3.1.xcframework.zip",
            checksum: "416186003d6b5e8c82bcb227c5a9a2c0416da9344e3eb19ccc7c9bcd9200aae9"
        )
    ]
)
