...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.5.3.xcframework.zip",
            checksum: "ec055b40c97a471c06cf2a965eb2006cdbaafe56b4240ce7c65be02696329db3"
        )
    ]
)
