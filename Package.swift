...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.4.0.xcframework.zip",
            checksum: "e7ffc49ea758e4dd487c1e42bde87db7d02df7d6cfd32f7b06d2857791330e1e"
        )
    ]
)
