...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.4.3.xcframework.zip",
            checksum: "b914a4629149f4a7d3ac6cbbc16ce670dbc72bd7b8d4b2fbd8d204ecba2c516f"
        )
    ]
)
