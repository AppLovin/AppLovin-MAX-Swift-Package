...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "AppLovinSDK",
            url: "https://artifacts.applovin.com/ios/com/applovin/applovin-sdk/AppLovinSDK-11.7.1.xcframework.zip",
            checksum: "1ad8a69ec67f4c6bcb95943792740078afd33b7bdeccdb6745197eb5a76e449e"
        )
    ]
)
